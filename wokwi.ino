...
const char* default_SSID = "Wokwi-GUEST"; // Nome da rede Wi-Fi (Wokwi-GUEST serve como rede default)
const char* default_PASSWORD = ""; // Senha da rede Wi-Fi (caso voce nao use o Wokwi-GUEST)
const char* default_BROKER_MQTT = "46.17.108.113"; // IP do Broker MQTT
const int default_BROKER_PORT = 1883; // Porta do Broker MQTT
const char* default_TOPICO_SUBSCRIBE = "/TEF/fimt001/cmd"; // Tópico MQTT de escuta
const char* default_TOPICO_PUBLISH_1 = "/TEF/fimt001/attrs"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_2 = "/TEF/fimt001/attrs/l"; // Tópico MQTT de envio de informações para Broker
const char* default_ID_MQTT = "fiware_001"; // ID MQTT
const int default_D4 = 2; // Pino do LED onboard
// Declaração da variável para o prefixo do tópico
const char* topicPrefix = "fimt001";
...
//https://wokwi.com/projects/406656458722404353 (link da simulacao)